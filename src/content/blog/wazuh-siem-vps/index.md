...
description: "Wazuh на VPS: Docker, агенты, FIM, vulnerability detection, Nginx, SSL и бэкапы. Open-source SIEM для VPS и homelab."
pubDate: 2026-07-03
category: DevOps
keywords:
  - "Wazuh SIEM VPS"
...
imageAlt: "Wazuh SIEM — self-hosted система мониторинга безопасности на VPS с агентами и алертами"
---
